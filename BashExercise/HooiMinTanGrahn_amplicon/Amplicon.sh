...
# fastqc (~/miniconda3/bin/fastqc), multiqc (~/miniconda3/envs/QcEnv/bin/multiqc), trimmomatic, hisat2 in bin and server (work in QcEnv), HTSeq in htseq_env), samtools in assembly
# bowtie2 in bowtie2, blast in blast_env, eggnog in eggnog, hooi in hooi, snakemake in snakemake
# Vsearch (~/miniconda3/envs/amplicon_env/bin/vsearch)
# pandaseq (~/miniconda3/envs/amplicon_env/bin/pandaseq)
# RDP classifier (~/miniconda3/envs/amplicon_env/bin/classifier)
# base                     /home/inf-51-2023/miniconda3
# QcEnv                    /home/inf-51-2023/miniconda3/envs/QcEnv
# assembly                 /home/inf-51-2023/miniconda3/envs/assembly
# blast_env                /home/inf-51-2023/miniconda3/envs/blast_env
# eggnog                   /home/inf-51-2023/miniconda3/envs/eggnog
# hooi                     /home/inf-51-2023/miniconda3/envs/hooi
# htseq_env                /home/inf-51-2023/miniconda3/envs/htseq_env
# snakemake                /home/inf-51-2023/miniconda3/envs/snakemake
# amplicon_env             /home/inf-51-2023/miniconda3/envs/amplicon_env

# aragorn, bcftools, bowtie2, fastp, hisat2_2.2.1, ncbi, Prodigal-GoogleImport, samtools-1.19.1, Trimmomatic-0.39, vcftools_0.1.13
# example for how to add folder to PATH
export PATH="$HOME/bin/bcftools:$PATH"
# How to open the bashrc file
nano ~/.bashrc
# How to open the bash_profile file
nano ~/.bash_profile
